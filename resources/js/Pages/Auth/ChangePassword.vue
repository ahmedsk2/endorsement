        ...
        <div class="channel-bar channel-bar-critical w-full max-w-sm rounded-md border border-line bg-panel p-8">
            ...
            <form @submit.prevent="submit" class="mt-6 space-y-4">
                <div>
                    ...
                    <input v-model="form.current_password" type="password" autocomplete="current-password" class="w-full rounded-md border border-line bg-panel px-3 py-2 text-ink focus:border-channel focus:ring-channel" />
