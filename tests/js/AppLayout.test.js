...
describe('AppLayout — role-gated navigation', () => {
    ...
    // entry (Levels); Task 10 adds a third (Calendar) — both belong beside Units here.
    it('shows the admin section with structure.manage alone, with Units, Levels and Calendar links', () => {
